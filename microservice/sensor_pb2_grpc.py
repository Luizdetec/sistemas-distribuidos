...
class SensorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessSensorData = channel.unary_unary(
                '/sensor.SensorService/ProcessSensorData',
                request_serializer=sensor__pb2.SensorDataRequest.SerializeToString,
                response_deserializer=sensor__pb2.SensorDataResponse.FromString,
...
def add_SensorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessSensorData': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=sensor__pb2.SensorDataRequest.FromString,
                    response_serializer=sensor__pb2.SensorDataResponse.SerializeToString,
            ),
    }
...
class SensorService(object):
    ...
    def ProcessSensorData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/sensor.SensorService/ProcessSensorData',
            sensor__pb2.SensorDataRequest.SerializeToString,
            sensor__pb2.SensorDataResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
